...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      {/* Reset Sent Message */}
      {resetSent && (
        <div className="mb-6 animate-in fade-in slide-in-from-top-2 duration-300 rounded-lg border border-teal-500/30 bg-teal-500/10 px-4 py-3 text-sm text-teal-400 backdrop-blur-sm">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors duration-200 focus:outline-none focus-visible:underline"
            >
              Forgot password?
            </button>
          </div>
