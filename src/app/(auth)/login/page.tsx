  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 overflow-hidden lg:flex lg:flex-col lg:items-center lg:justify-center">
        {/* Gradient Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0f172a] via-[#0c4a6e] to-[#164e63]" />

        {/* Animated Decorative Shapes */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 -left-24 size-96 rounded-full bg-cyan-500/10 blur-3xl animate-pulse" />
          <div className="absolute top-1/2 -right-32 size-[500px] rounded-full bg-blue-500/10 blur-3xl animate-pulse [animation-delay:2s]" />
          <div className="absolute -bottom-32 left-1/4 size-80 rounded-full bg-teal-500/10 blur-3xl animate-pulse [animation-delay:4s]" />
          <div className="absolute top-1/4 left-1/3 size-64 rounded-full bg-orange-500/5 blur-3xl animate-pulse [animation-delay:3s]" />
        </div>
        ...
        <div className="relative z-10 max-w-lg px-12">
          ...
          {/* Bottom accent line */}
          <div className="mt-16 h-px w-full bg-gradient-to-r from-transparent via-cyan-500/40 to-transparent" />
